...
echo "$print_winner $singlet_combinations $singlet_combination_percentages"
echo 
echo "For Doublet Combination"
echo $print_winner $doublet_combinations $doublet_combination_percentages

echo "For Triplet Combination"
echo $print_winner $triplet_combinations $triplet_combination_percentages


echo "For All Combinations"
echo $print_winner $total_combinations $total_combination_percentages
